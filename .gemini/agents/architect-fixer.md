...
5. **Self-Improvement**: After every significant task, activate the `self-improvement` skill to document learnings and update project instructions (`GEMINI.md`).
...
6. **Learn**: Reflect and update the codebase's "memory" (GEMINI.md, LEARNINGS.md).
