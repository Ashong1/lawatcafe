<x-guest-layout>
    <x-slot name="header">
        ...
        <p class="text-sm text-[#A1887F]" style="font-family: 'Montserrat', sans-serif;">Please enter your new password below</p>
    </x-slot>
    ...
    <form method="POST" action="{{ route('password.store') }}" class="space-y-5 max-w-md mx-auto w-full">
        ...
        <div x-data="{ show: false }">
            <label for="password" class="block text-xs font-medium text-[#A1887F] mb-1 ml-1">New Password</label>
            <div class="relative">
        ...
        <!-- Confirm Password -->
        <div x-data="{ show: false }">
            <label for="password_confirmation" class="block text-xs font-medium text-[#A1887F] mb-1 ml-1">Confirm Password</label>
            <div class="relative">
