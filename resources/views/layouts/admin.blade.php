        ...
        <nav x-ref="sidebarNav"
            ...
            <div class="space-y-1">
                <button @click="menus.inventory = !menus.inventory" 
                    ...
                    <x-lucide-chevron-down x-show="sidebarOpen" class="w-4 h-4 transition-transform duration-[400ms]" x-bind:class="menus.inventory ? 'rotate-180' : ''" />
                </button>
            ...
            <div class="space-y-1">
                <button @click="menus.network = !menus.network" 
                    ...
                    <x-lucide-chevron-down x-show="sidebarOpen" class="w-4 h-4 transition-transform duration-[400ms]" x-bind:class="menus.network ? 'rotate-180' : ''" />
                </button>
            ...
            <div class="space-y-1">
                <button @click="menus.settings = !menus.settings"
                    ...
                    <x-lucide-chevron-down x-show="sidebarOpen" class="w-4 h-4 transition-transform duration-[400ms]" x-bind:class="menus.settings ? 'rotate-180' : ''" />
                </button>
            ...
            <div class="space-y-1">
                <button @click="menus.system = !menus.system"
                    ...
                    <x-lucide-chevron-down x-show="sidebarOpen" class="w-4 h-4 transition-transform duration-[400ms]" x-bind:class="menus.system ? 'rotate-180' : ''" />
                </button>
