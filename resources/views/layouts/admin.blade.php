    ...
    <script>
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('baristaAI', () => ({
                ...
                thinking: false,
                history: [
                    { role: 'assistant', content: "Hello Admin! I am Barista AI. I've analyzed today's data and I'm ready to help you optimize Lawa't Kape. How can I assist you today?" }
                ],
