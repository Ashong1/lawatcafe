            ...
            <div class="space-y-8">
                ...
                <div class="bg-[#3E2723] p-6 md:p-8 rounded-3xl shadow-xl text-white">
                    <div class="flex items-center gap-3 mb-8 border-b border-white/10 pb-6">
                        ...
                        <div>
                            <h3 class="text-sm font-black uppercase tracking-widest">Free Wi-Fi Strategy</h3>
                            <p class="text-[10px] text-amber-200 font-medium italic">Set criteria for complimentary network access.</p>
                        </div>
                    </div>

                    <div class="space-y-6">
                        <div>
                            <label class="block text-[10px] font-black text-amber-200 uppercase mb-2 tracking-widest">Minimum Order for Free Access (₱)</label>
                            <input type="number" name="free_wifi_min_amount" value="{{ $settings['free_wifi_min_amount'] }}" class="w-full bg-white/10 border-2 border-white/20 rounded-xl px-4 py-3 text-sm font-bold focus:outline-none focus:border-amber-500 transition-all text-white placeholder-white/30" placeholder="200">
                        </div>
                        <div>
                            <label class="block text-[10px] font-black text-amber-200 uppercase mb-2 tracking-widest">Free Access Duration (Minutes)</label>
                            <input type="number" name="free_wifi_duration" value="{{ $settings['free_wifi_duration'] }}" class="w-full bg-white/10 border-2 border-white/20 rounded-xl px-4 py-3 text-sm font-bold focus:outline-none focus:border-amber-500 transition-all text-white placeholder-white/30" placeholder="60">
                        </div>
                    </div>
                    ...
                    <div class="mt-8 flex gap-4 p-4 bg-white/5 rounded-2xl border border-white/10">
                        ...
                        <p class="text-[10px] leading-relaxed text-amber-100/70 font-medium italic">
                            These settings automatically provision a voucher when a sale meets the price threshold. Staff can also manually override this at the POS.
                        </p>
                    </div>
                </div>
